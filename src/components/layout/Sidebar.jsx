...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-2 flex items-center justify-between rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-2.5 py-1.5">
        ...
        <button
          ...
          className="rounded-full border border-slate-800 bg-slate-900 p-1 text-slate-300 transition hover:text-emerald-400"
        >
