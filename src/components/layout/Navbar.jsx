...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-20 flex items-center justify-between gap-3 border-b border-slate-800 bg-slate-950/75 px-4 py-3 backdrop-blur-xl"
    >
      <div className="flex items-center gap-3">
        ...
        <div className="hidden items-center gap-3 rounded-2xl border border-slate-800 bg-slate-900/70 px-3 py-2 md:flex">
          <Search size={16} className="text-slate-400" />
          <input
            type="text"
            placeholder="Search reports, products, customers"
            className="w-56 bg-transparent text-sm text-white outline-none placeholder:text-slate-500 xl:w-64"
          />
        </div>
      </div>

      <div className="flex items-center gap-2 sm:gap-3">
        <button type="button" className="rounded-2xl border border-slate-800 bg-slate-900/70 p-2.5 text-slate-300 transition hover:text-emerald-300">
          <Bell size={18} />
        </button>
        <button type="button" className="rounded-2xl border border-slate-800 bg-slate-900/70 p-2.5 text-slate-300 transition hover:text-emerald-300">
          <Mail size={18} />
